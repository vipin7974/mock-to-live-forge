  ...
  const pillars = [
    {
      ...
      title: "Listen First",
      description:
        "Creating a judgment-free space where your concerns can be heard, understood.",
    },
    {
      icon: <HeartHandshake className="w-8 h-8" />,
      title: "Culturally Informed Care",
      description:
        "Integrating traditional values with modern healthcare approaches.",
    },
    {
      icon: <Lightbulb className="w-8 h-8" />,
      title: "Personalized Solutions",
      description:
        "Tailoring treatments to your lifestyle, family dynamics, and personal goals.",
    },
    {
      icon: <Handshake className="w-8 h-8" />,
      title: "Long-term Support",
      description:
        "Building sustainable habits and providing ongoing guidance.",
    },
  ];
  ...
  const coreServices = [
    {
      ...
      description:
        "Professional counseling by anxiety, depression, stress management, sleep disorders. Our therapists understand the unique challenges facing Indian men today and tailor treatments accordingly.",
    ...
    },
    {
      ...
      description:
        "Specialized care for men's physical health including cardiovascular health, nutrition, and general wellness. We address fitness myths and cultural barriers to create effective, achievable health plans.",
      buttonText: "Learn More",
    },
    {
      ...
      description:
        "Premium products and guidance for men's sexual wellbeing. Quality products, discreet packaging, and informed professional support.",
      buttonText: "Learn More",
    },
    {
      ...
      description:
        "Dedicated support for fathers in the two roles, enhancing your relationship with your children during their growth in your fatherhood journey.",
      buttonText: "Learn More",
    },
  ];
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center px-4">
          <div ref={heroRef} className="max-w-4xl text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-hero-foreground/90 max-w-3xl mx-auto">
              At Be Ballsy, we understand that men's health isn't
              one-size-fits-all. Our holistic approach addresses the unique
              challenges faced by Indian men across all life stages and
              circumstances.
            </p>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We believe in treating the whole person, not just symptoms. Our
              evidence-based methodology focuses on:
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            {coreServices.map((service, index) => (
              <div
                key={index}
                className="bg-card/10 backdrop-blur-sm rounded-lg p-6 border border-card/20 flex flex-col h-full"
              >
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div ref={finalSectionRef} className="max-w-2xl py-20">
            ...
            <p className="text-xl mb-8 text-hero-foreground/90">
              Your wellness journey begins with a simple step. Schedule a
              confidential consultation and our specialist will help you start
              down the path.
            </p>
            <p className="text-lg mb-8 text-hero-foreground/80">
              During your initial call or meeting we create a personalized
              action plan.
            </p>
            <p className="text-lg mb-8 text-hero-foreground/80">
              Book your wellness journey with your first gift to yourself: the
              freedom to ask for what you might plan for.
            </p>

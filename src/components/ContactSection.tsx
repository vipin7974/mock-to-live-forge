      ...
      <div className="container mx-auto">
        ...
        <div ref={contentRef} className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="text-hero-foreground/80">support@beballsy.com</div>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="text-hero-foreground/80">Available Mon-Fri, 9 AM - 6 PM</div>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="text-hero-foreground/80">Book appointments 24/7 through our portal</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-background/10 backdrop-blur-sm rounded-lg p-8">
            <h3 className="text-2xl font-bold mb-6 text-hero-foreground">Send Us a Message</h3>

...
const Header = () => {
  ...
  return (
    <header className="bg-background border-b border-border/20 px-4 lg:px-6 py-4 sticky top-0 z-50">
      <div className="container mx-auto flex items-center justify-between">
        {/* Logo */}
        <div className="text-2xl font-bold text-foreground">Be Ballsy</div>
          ...
          <div className="relative">
            ...
            {isServicesOpen && (
              <div 
                ...
                onMouseLeave={() => setIsServicesOpen(false)}
              >
                <a href="#" className="block px-4 py-2 text-sm text-foreground hover:bg-muted hover:text-primary transition-colors">
                  Mental Health
                </a>
                <a href="#" className="block px-4 py-2 text-sm text-foreground hover:bg-muted hover:text-primary transition-colors">
                  Physical Wellness
        ...
        <Button 
          variant="default" 
          className="hidden lg:flex bg-primary hover:bg-primary/90 text-white px-6 py-2 rounded-lg font-medium"
        >
          Book Consultation
        </Button>
      ...
      {isMenuOpen && (
        <div className="lg:hidden border-t border-border/20 bg-background">
          <nav className="container mx-auto py-4 space-y-4">
            ...
            <Button 
              variant="default" 
              className="w-full bg-primary hover:bg-primary/90 text-white px-6 py-2 rounded-lg font-medium mt-4"
            >
              Book Consultation
            </Button>
          </nav>
